...
// 游戏开始
		function start(){	
			 ...
			 // 	sei = setTimeout(function(){
				...
				// 		            imgUrl: 'http://omkds.douyar.cc//mobile2/templates/h5game/img/fx.jpg', // 分享图标
...
//如果点中的话   消失  并加分   而后出现频率增加
		function removeImg(obj){
			...
			if(src == '/mobile2/templates/h5game/img/boom.png'){
				
				$(obj).attr('src',function(){
					$(obj).fadeOut(800);
					con-=15;
					return '/mobile2/templates/h5game/img/booms.png';
				});
			}else if(src == '/mobile2/templates/h5game/img/1.png'){
				
				$(obj).attr('src',function(){
					$(obj).fadeOut(800);
					con+=10;
					return '/mobile2/templates/h5game/img/2s.png';
				})
			}else if(src == '/mobile2/templates/h5game/img/3.png'){
				
				$(obj).attr('src',function(){
					$(obj).fadeOut(800);
					con+=20;
					return '/mobile2/templates/h5game/img/4s.png';
				})
			}
...
//随机图片src
		function randomImg(){
			...
			var src = ["/mobile2/templates/h5game/img/1.png","/mobile2/templates/h5game/img/boom.png","/mobile2/templates/h5game/img/3.png","/mobile2/templates/h5game/img/1.png","/mobile2/templates/h5game/img/3.png"];
...
//中间大快递出现    点击加分并更换src
		function bigSrc(a){
			...
			var srcs = ["/mobile2/templates/h5game/img/1.png","/mobile2/templates/h5game/img/3.png","/mobile2/templates/h5game/img/4.png","/mobile2/templates/h5game/img/1.png","/mobile2/templates/h5game/img/3.png","/mobile2/templates/h5game/img/4.png","/mobile2/templates/h5game/img/1.png"];
			...
			if(con>500){
				$('.yao').hide();
				// speed = 250;
				also = setInterval(moveDiv,speed);
			}
		} 
		...
		function luck(){
			...
			$.ajax({
		        ...
		        success: function (data) {
		        	//二元 
		        	if(data == 1){
		        		$('.prize').css('background-image','url(/mobile2/templates/h5game/img/prize_3.png)');
		        		$('.prize').show();
		        		$('.containerss').show();
		        	//十元
		        	}else if(data == 2){
		        		$('.prize').css('background-image','url(/mobile2/templates/h5game/img/prize_2.png)');
		        		$('.prize').show();
		        		$('.containerss').show();
		        	//五十元
		        	}else if(data == 3){
		        		$('.prize').css('background-image','url(/mobile2/templates/h5game/img/prize_1.png)');
		        		$('.prize').show();
		        		$('.containerss').show();
