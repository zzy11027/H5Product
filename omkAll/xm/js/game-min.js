...
var __extends = this.__extends || function(t, e) {
	...
	Main = function(t) {
		...
		e.prototype.onAddToStage = function(t) {
			...
			/iPhone/i.test(navigator.userAgent) ? (e.factor = 4 / 3, RES.loadConfig("/templates/omk/xm/resource/resource.json", "/templates/omk/xm/resource/assets/360/")) : (e.factor = 1, RES.loadConfig("/templates/omk/xm/resource/resource.json", "/templates/omk/xm/resource/assets/360/"))
		};
