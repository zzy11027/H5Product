...
function createItem(){
	...
	if(score>0&&score<100){//20-50分，下降速度加快，创建障碍物速度也加快
		speedIn=400;
		speedDown=1600;
		reInterval();
	}
	...
	var html = '<div class="obj '+roleName+'" data-role="'+roleName+'" style="left:'+strLeft[randleft]+'"><img src="/mobile/templates/2018qixi/img/en_'+enemy_img+'.png"/</div>';
