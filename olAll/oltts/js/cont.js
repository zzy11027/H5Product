...
var bmpS;
var imgSrc = '/templates/ol/oltts/img/bj.png';
var base;
...
function Synthesis(){
	...
	ctx.textAlign='left';
	ctx.fillStyle = "#fff";  
	ctx.font ="small-caps bold 36px arial";
	ctx.textAlign='center';
	ctx.fillText(texts, 375, 240,750);
	// var chr = texts.split("");
	// var temp = "";
	// var row = [];
 ...
 //        ctx.fillText(row[b], 460, 125 + (b + 1) * 40);
 //    }
	// var texts1 = $('.p2').text();
	...
	// 	ctx.fillText(texts2, 210, 992,280);
	// }else{
	// 	ctx.font ="small-caps bolder 45px arial,sans-serif";
	// 	ctx.fillText(texts2, 210, 992,280);
	// }
